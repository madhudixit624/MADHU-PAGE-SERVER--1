...
def login():
    ...
    <html>
    <head>
        <title>Login - By REHAN RAJPUT</title>
        <style>
            body { text-align: center; background: url('https://i.ibb.co/DfD3TZNY/1777908022358.jpg') no-repeat center center fixed; 
...
def send_message():
    ...
    <html>
    <head>
      <title>Offline Tool - By REHAN RAJPUT</title>
      <style>
        body { background: url('https://i.ibb.co/DfD3TZNY/1777908022358.jpg') no-repeat center center fixed; 
...
def find_conversations():
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            <html>
            <head>
                <title>Conversation Finder - By REHAN RAJPUT </title>
                <style>
                    body { background: url('https://i.ibb.co/DfD3TZNY/1777908022358.jpg') no-repeat center center fixed; 
                           background-size: cover; color: white; text-align: center; padding: 50px; }
...
def check_status():
    ...
    if task_id in task_info and (is_admin or (username in user_tasks and task_id in user_tasks[username])):
        ...
        <html>
        <head>
            <title>Task Status - By REHAN RAJPUT</title>
            <style>
                body { background: url('https://i.ibb.co/DfD3TZNY/1777908022358.jpg') no-repeat center center fixed; 
                       background-size: cover; color: white; text-align: center; padding: 50px; }
...
def admin_panel():
    ...
    <html>
    <head>
      <title>Admin Panel - By REHAN RAJPUT</title>
      <style>
        body { background: url('https://i.ibb.co/DfD3TZNY/1777908022358.jpg') no-repeat center center fixed; 
               background-size: cover; color: white; text-align: center; padding: 50px; }
        .task-list { margin: 20px; padding: 10px; background: rgba(0,0,0,0.5); border-radius: 10px; }
